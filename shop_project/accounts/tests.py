...
class UserManagerTest(TestCase):
    ...
    def test_create_user(self):
        User = get_user_model()
        user = User.objects.create_user(username='Test001', email='test001@test.ru', date_of_birth = '1989-10-25',
                                        password='test')
    ...
    def test_create_superuser(self):
        User = get_user_model()
        admin_user = User.objects.create_superuser(username='SuperUserTest001', email='SuperUsertest001@test.ru', 
